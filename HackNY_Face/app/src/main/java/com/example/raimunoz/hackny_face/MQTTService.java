...
public class MQTTService extends Service {
    ...
    private void doConnect(){
        ...
        options.setUserName("embwzrwf");
        options.setPassword("EaxFW762iu7v".toCharArray());
        options.setCleanSession(true);
        try {
            Log.e(TAG,"Starting connection to MQTT");
            mqttClient = new MqttAsyncClient("tcp://m10.cloudmqtt.com:12068", deviceId, new MemoryPersistence());
